...
public interface TarjetaMapper {
    ...
    @Select("SELECT BN05.B05_ID_TAR,"
            ...
            + "AND (SELECT B07_ESTADO FROM BN_SATE.BNSATE07_EST_TARJETA WHERE B07_ETA = (SELECT MAX(B07.B07_ETA)"
            + " FROM BN_SATE.BNSATE07_EST_TARJETA B07 WHERE B07.B05_ID_TAR = BN05.B05_ID_TAR)) = #{codEstadoTarjeta} AND BN00.B00_NUM_RUC = #{numRuc}")
